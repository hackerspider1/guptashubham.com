  ...
  return (
    <div className={cn("relative block md:hidden", className)}>
      ...
      <button
        ...
        className="h-6 w-6 rounded-full bg-gray-50 dark:bg-neutral-800 flex items-center justify-center"
      >
...
function IconContainer({
  ...
  let widthTransform = useTransform(distance, [-150, 0, 150], [30, 80, 30]);
